...
//uniapp获取页面参数
const querry = defineProps<{ type: string }>()
console.log(querry)
const currUrlMap = hotMap.find((v) => v.type === querry.type)
...
//推荐封面
const RecommendPicture = ref('')

//获取热门推送
const getHotRecommendData = async () => {
  const res = await getHotRecommendAPI(currUrlMap!.url)
  console.log(res)
  RecommendPicture.value = res.result.bannerPicture
...
<template>
  <view class="viewport">
    <!-- 推荐封面图 -->
    <view class="cover">
      <image :src="RecommendPicture"></image>
    </view>
    <!-- 推荐选项 -->
    <view class="tabs">
      <text
